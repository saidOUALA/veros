...
VARIABLES = {
    ...
    "u_bar": Variable("Zonal velocity time average", U_GRID, "m/s", "Zonal velocity time average", write_to_restart=False),
    "v_bar": Variable("Meridional velocity time average", V_GRID, "m/s", "Meridional velocity time average", write_to_restart=False),
