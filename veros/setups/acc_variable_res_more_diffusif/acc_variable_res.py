...
on 2024-08-24 18:01:42 UTC.
"""

__VEROS_VERSION__ = '0+untagged.1796.gc323e73.dirty'
...
class ACCResSetup(VerosSetup):
    ...
    def set_parameter(self, state):
        ...
        settings.identifier = "acc_runs/acc_simulation_quarter_more_diffusif_post_spinup_GT/acc_simulation_quarter_more_diffusif_post_spinup_GT"
        settings.description = "My ACC setup"
        settings.restart_input_filename = "acc_runs/acc_simulation_quarter_more_diff_spinup/acc_simulation_quarter_more_diff_spinup_368172.restart.h5"
        
        # for diagnosing resolved eke
        settings.compute_resolved_eke = True
        settings.avg_file_path = "acc_runs/acc_simulation_quarter_more_diff_spinup/acc_simulation_quarter_more_diff_spinup.averages.nc"
