...
class IndianOceanSetup(VerosSetup):
    """A climatological simulation of the Indian Ocean, Adapted from a ROMS simulation by Lachkar et al.

    Forcing and initial conditions are taken from the ROMS Simulation .

    Boundary forcings are implemented via sponge layers in xx yy zz.
