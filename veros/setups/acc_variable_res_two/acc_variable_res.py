...
class ACCResSetup(VerosSetup):
    ...
    def set_parameter(self, state):
        ...
        settings.identifier = "acc_runs/acc_simulation_two_post_spinup_GT/acc_simulation_two_post_spinup_GT"
        settings.description = "My ACC setup"
        settings.restart_input_filename = "acc_runs/acc_simulation_two_spinup/acc_simulation_two_spinup_92043.restart.h5"
        
        # for diagnosing resolved eke
        settings.compute_resolved_eke = True
        settings.avg_file_path = "acc_runs/acc_simulation_two_spinup/acc_simulation_two_spinup.averages.nc"
        ...
        delta = 2/res
        ratio = delta**2
        settings.nx, settings.ny, settings.nz = 30, 42, 15#248,324,15#,30, 42, 15
