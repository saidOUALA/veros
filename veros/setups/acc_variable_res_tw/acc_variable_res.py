...
This Veros setup file was generated by
   ...
   $ veros copy-setup acc_variable_res

on 2024-07-25 11:42:11 UTC.
"""

__VEROS_VERSION__ = '0+untagged.1795.g74a26d8'
...
class ACCResSetup(VerosSetup):
    ...
    def set_parameter(self, state):
        ...
        settings.identifier = "acc_runs/acc_simulation_twelvth/acc_simulation_twelvth_post_spinup_test"
        settings.description = "My ACC setup"
        settings.restart_input_filename = "acc_runs/acc_simulation_twelvth_spinup/acc_simulation_twelvth_spinup_0144.restart.h5"
        
        # for diagnosing resolved eke
        settings.compute_resolved_eke = True
        settings.avg_file_path = "acc_runs/acc_simulation_quarter_spinup/acc_simulation_twelvth_spinup.averages.nc"
        ...
        delta = 2/res
        ratio = delta**2
        settings.nx, settings.ny, settings.nz = 248*3,324*3,15#,30, 42, 15
    ...
    def set_grid(self, state):
        ...
        vs.dxt = update(vs.dxt, at[...], 1/12)
        vs.dyt = update(vs.dyt, at[...], 1/12)
